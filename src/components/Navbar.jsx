      ...
      <div className="bg-[#DC2626] px-3 sm:px-4 py-2.5 sm:py-3 w-full">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            {/* Language Switcher in Red Header Menu */}
            <button
              onClick={toggleLanguage}
              className="flex items-center gap-1 bg-white/15 hover:bg-white/25 active:scale-95 text-white border border-white/25 px-2.5 py-1.5 rounded-xl text-xs font-black transition-all cursor-pointer shadow-xs"
